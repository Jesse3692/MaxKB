...
urlpatterns = [
    ...
    path('v1/completions', views.CompletionsView.as_view(), name='v1_completions'),
    path('v1/chat/completions', views.ChatCompletionsView.as_view(), name='v1_chat_completions'),
    path('v1/completions/chat/completions', views.ChatCompletionsView.as_view(), name='v1_completions_chat_completions'),
